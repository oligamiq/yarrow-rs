// ref https://github.com/Cameleon00722/horizon/blob/ebbe48975c62ee5886698ee550d337578f5a7cb7/src/prng.rs
...
impl Yarrow {
    ...
    pub fn reseed(&mut self, new_seed: u128) {
        {
    ...
    pub fn combine_entropy(&self) -> u128 {
    ...
    pub fn mix_entropy(&mut self, entropy: u128) {
